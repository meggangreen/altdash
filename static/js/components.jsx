        ...
        <div id="nav-container" className="container-fluid">
          ...
          <div id="nav-menu" className="collapse navbar-collapse">
            <ul className="nav navbar-nav navbar-right">
              <li className="active"><ReactRouterDOM.Link to='/'>Home<span className="sr-only"> (current)</span></a></li>
              <li><ReactRouterDOM.Link to='/map'>Map</a></li>
              <li><ReactRouterDOM.Link to='/contact'>Contact</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /#nav-container -->
      </nav>
...
class Dynamic extends React.Component {
  <ReactRouterDOM.Switch>
    ...
    <ReactRouterDOM.Route path='/:country' component={ ChartTiles } />
    <ReactRouterDOM.Route exact path='/map' component={ Map } />
    <ReactRouterDOM.Route exact path='/contact' component={ Contact } />
  </ReactRouterDOM.Switch>
}

class ChartTiles extends React.Component {
  render() {
    return (
